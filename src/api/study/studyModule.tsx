...
export const getAllStudyList = (search: string, type: number, order: number, pagination: number) => {
    return get(`study/post/allstudylist?search=${search}&category=${type}&order=${order}&pagiantenum=${pagination}`);
}